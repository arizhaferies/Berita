...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#newSubMenuModal"><i class="fas fa-fw fa-plus"></i> Tambah Submenu</a>
    </div>
...
<?php foreach ($subMenu as $esm) : ?>
    <div class="modal fade" id="editSubMenuModal<?= $esm['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editSubMenuModal<?= $esm['id'] ?>Label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSubMenuModal<?= $esm['id'] ?>Label">Tambah Sub Menu</h5>
