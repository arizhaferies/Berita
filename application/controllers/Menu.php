...
class Menu extends CI_Controller
{
    ...
    public function submenu()
    {
        ...
        if ($this->form_validation->run() ==  false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Sub Menu Berhasil Dibuat!</div>');
    ...
    {
        $this->db->update('user_sub_menu', ['menu_id' => $this->input->post('menu_id')], ['id' => $id]);
